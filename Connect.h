...
#define ChannelPage @"http://mapi.yinyuetai.com/recommend/video/aggregation.json"

#define ChannelDetail @"http://mapi.yinyuetai.com/channel/videos.json?"
...
#define VBang @"http://mapi.yinyuetai.com/vchart/trend.json?"


/**
 * 播放页面
 */
#define VideoPlay @"http://mapi.yinyuetai.com/video/show.json?"
...
#define SearchTop @"http://mapi.yinyuetai.com/search/top_keyword.json"


#define SearchTable @"http://mapi.yinyuetai.com/search/video.json?"
