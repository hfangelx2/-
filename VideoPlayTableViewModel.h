...
@interface VideoPlayTableViewModel : NSObject
...
@property(nonatomic,strong)NSString *regdate; // 上传时间
...
@property(nonatomic,strong)NSString *uhdUrl; // uhd类型的视频网址;
@property(nonatomic,strong)NSString *shdUrl;   // shd类型的视频网址;
